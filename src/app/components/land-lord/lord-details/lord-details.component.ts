...
@Component({
  selector: 'app-lord-details',
  templateUrl: './lord-details.component.html',
  styleUrls: ['./lord-details.component.scss']
})
export class LordDetailsComponent {
