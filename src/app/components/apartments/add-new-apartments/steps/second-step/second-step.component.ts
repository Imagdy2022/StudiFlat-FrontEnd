...
export class SecondStepComponent {
  ...
  constructor(
    ...
    this.apt_UUID = localStorage.getItem('generalInfoForm');
    // this.apt_UUID = JSON.parse(localStorage.getItem('generalInfoForm')??"{}")['uuid'];
     this.apt_UUID = JSON.parse(localStorage.getItem('generalInfoForm')??"{}") ;
    console.log((this.apt_UUID).apartment_ID);
...
let setId= this.arrNamesbathroom[id].bathroom_Details.length;
  ...
  Create_Apart_Equipment(data: any) {
    ...
    let objectData = {
      ...
      apartment_ID:(this.apt_UUID).apartment_ID,
